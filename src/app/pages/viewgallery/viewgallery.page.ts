...
@Component({
  ...
  templateUrl: './viewgallery.page.html',
  styleUrls: ['./viewgallery.page.scss'],
})
export class ViewgalleryPage implements OnInit {
  ...
  profilePic: any;
  showProfile: boolean;
  constructor(public router: Router, public docUpload: DocumentuploadService, public loc: Location, public acCtrl: ActionSheetController,
...
console.log(val,"rrrrrrrrrrrrrrr");
      // if (val.profile) {
  ...
  onClick() {
    ...
    this.router.navigate(['/fipredocument'], { skipLocationChange: true, queryParams: { gallery: this.showProfile ? true : false } });
  }
